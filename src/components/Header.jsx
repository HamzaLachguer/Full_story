...
const Header = () => {
  ...
  return (
    <header className={`fixed top-0 w-full z-50 bg-secondary px-4 md:px-6 lg:px-15 text-white flex items-start transition-all duration-300 ${ isMenuOpen ? "h-screen lg:h-16" : "h-16 overflow-hidden" }`}>
